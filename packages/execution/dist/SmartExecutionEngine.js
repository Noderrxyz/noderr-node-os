...
exports.SmartExecutionEngine = void 0;
const events_1 = require("events");
/**
 * Smart execution engine
 */
class SmartExecutionEngine extends events_1.EventEmitter {
    config;
    logger;
     ...
     * Create execution plan
     */
    async createExecutionPlan(order) {
        const slices = [];
     ...
     */
    async selectVenue(order, sliceSize, sliceIndex) {
        if (this.config.enableSmartRouting && this.rlRouter) {
            ...
            const venues = Array.from(this.venueConnections.keys());
            venues.sort((a, b) => (this.config.venuePriorities[b] || 0) - (this.config.venuePriorities[a] || 0));
     ...
     */
    async executeSlice(slice, order) {
        const startTime = Date.now();
     ...
     */
    async estimateExecutionCosts(order, slices) {
        let totalCost = 0;
        let totalSlippage = 0;
...
//# sourceMappingURL=SmartExecutionEngine.js.map