#!/bin/bash
#
# Noderr Validator Node - CT303 Update Script
# Run this on pve-node-c as root (in the Proxmox shell or via: pct enter 303)
#
# Usage:
#   pct enter 303
#   bash /tmp/update_validator_ct303.sh
#
# OR run directly from the Proxmox host shell:
#   pct exec 303 -- bash -s < /tmp/update_validator_ct303.sh
#
set -euo pipefail
